...
<div class="row">
    <div class="col-md-8 mx-auto">
        ...
        <div class="card card-body shadow-sm">
            <h2><?php echo htmlspecialchars($datos['titulo'] ?? 'Agregar Usuario Admin'); ?></h2>
            ...
            <form action="<?php echo RUTA_URL; ?>/usuarios/agregar" method="POST">
                ...
                <div class="mb-3">
                    <label for="password" class="form-label">Contraseña: <sup class="text-danger">*</sup></label>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control <?php echo (!empty($datos['password_error'])) ? 'is-invalid' : ''; ?>"
                           id="confirmar_password" name="confirmar_password" required minlength="6">
                    <span class="invalid-feedback"><?php echo $datos['password_error'] ?? ''; ?></span>
                </div>
                <div class="d-grid">
